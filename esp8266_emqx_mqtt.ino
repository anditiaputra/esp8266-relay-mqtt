...
#define ledPin 2 // GPIO 2 (D4) for LED
#define relay1Pin 4
#define relay2Pin 5
...
// WiFi settings
const char *ssid = "ADYAKIDS";       // Replace with your WiFi name
const char *password = "Uprut2024";  // Replace with your WiFi password

// MQTT Broker settings
const char *mqtt_broker = "ic1ebc99.ala.asia-southeast1.emqxsl.com";  // EMQX broker endpoint
const char *mqtt_topic = "pci/gerbang";                               // MQTT topic
const char *mqtt_username = "pci";                                    // MQTT username for authentication
const char *mqtt_password = "Puricemaraindah2025";                    // MQTT password for authentication
...
void mqttCallback(char* topic, byte* payload, unsigned int length) {
    ...
    if (message == "bukagerbang") {
        ...
        digitalWrite(ledPin, HIGH); // Turn on relay 2 (tutup gerbang)
        Serial.println("Turning on led");
    } else if (message == "ledOFF") {
        digitalWrite(ledPin, LOW); // Turn on relay 2 (tutup gerbang)
